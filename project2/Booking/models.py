...
class Bookings(models.Model):
    ...
    player_2 = models.ForeignKey(Players, related_name="player_2", on_delete=models.CASCADE, null=True, blank=True,
                                 db_constraint=False)
    player_3 = models.ForeignKey(Players, related_name="player_3", on_delete=models.CASCADE, null=True, blank=True,
                                 db_constraint=False)
    coach_data_ids = models.ForeignKey(Coaches, on_delete=models.CASCADE, null=True, blank=True, db_constraint=False)
    ground_provider_ids = models.ForeignKey(GroundProviders, on_delete=models.CASCADE, null=True, blank=True,
                                            db_constraint=False)
