...
class CoachesAdmin(admin.ModelAdmin):
      list_display=( 'qualification','certificate','prices','technique','specialities','experience','created_at','updated_at','coaches_profile_id')
...
class CourtDetailAdmin(admin.ModelAdmin):
      list_display =('court_name','surface_type','price','created_at','updated_at','light_availability','ground_datas_ids')

admin.site.register(CourtDetails,CourtDetailAdmin)

# class ProfileAvailabilityDetailAdmin(admin.ModelAdmin):
      # list_display =('court_name','surface_type','price','created_at','updated_at','light_availability','ground_datas')
...
class AddressAdmin(admin.ModelAdmin):
      # list_display = ('flat_no','city','profile_data_id','created_at','updated_at')
